...
function cards() {
  ...
  (0,_services_sevices__WEBPACK_IMPORTED_MODULE_0__.getResource)("http://localhost:3000/menu").then((data) => {
...
function forms(fomrSelector, modalTimerId) {
  const forms = document.querySelectorAll(fomrSelector);
  const message = {
